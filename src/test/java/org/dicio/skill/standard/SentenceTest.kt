...
/**
 * [1-3]p means [1-3] packs in the sentence, that is, [0-2] capturing groups
 * (e.g. test1p means testOnePack, i.e. a sentence with 0 capturing groups)
 */
class SentenceTest {
    @Test
    fun test1p() {
    ...
    fun test2pLeftEmpty() {
        ...
        assertSentence(
            s,
            "hello bob how are steaks doing inside you",
            0.3f,
            0.4f,
            "hello bob",
            null
    ...
    fun test3p() {
        ...
        assertSentence(
            s,
            "i want five and a half liters of soy milk please",
            1.0f,
            1.0f,
            "five and a half",
            "soy milk"
        ...
        assertSentence(
            s,
            "five and a half liters of soy milk",
            0.3f,
            0.4f,
            "five and a half",
            "soy milk"
        ...
        assertSentence(
            s,
            "you need five liters of milk please",
            0.6f,
            0.7f,
            "you need five",
            "milk"
        ...
        assertSentence(
            s,
            "i a a a a want f liters of milk please",
            0.9f,
            1.0f,
            "a a a a want f",
            "milk"
    ...
    fun test3pLeftEmpty() {
        ...
        assertSentence(
            s,
            "five and a half liters of soy milk please",
            1.0f,
            1.0f,
            "five and a half",
            "soy milk"
    ...
    @Test
    fun testOptionalFollowedByCapturingGroup() {
        val s = Sentence(
            "", intArrayOf(0),
            diw("open", 1, 1, 3),
            diw("the", 2, 2),
    ...
    @Test
    fun testCapturingGroupFollowedByOptional() {
        val s = Sentence(
            "", intArrayOf(0),
            dsw("buy", 1, 1),
            capt("0", 0, 2, 3),
    ...
    @Test
    fun testOptionalCapturingGroup() {
        val s = Sentence(
            "", intArrayOf(0),
            diw("weather", 1, 1, 2),
            capt("0", 0, 2)
    ...
    companion object {
        const val FLOAT_EQUALS_DELTA: Float = 0.0001f
        ...
        private fun assertSentence(
            ...
            if (a == b) {
                Assert.assertEquals(
                    "Score $score $scoreResult is not equal to $a",
                    a, score, FLOAT_EQUALS_DELTA
                )
            } else {
                Assert.assertTrue(
                    "Score $score $scoreResult is not in range [$a, $b]",
                    score in a..b
                )
            }
            ...
            Assert.assertEquals(
                ((if (captGr0 != null) 1 else 0) + (if (captGr1 != null) 1 else 0)).toLong(),
                r.capturingGroupRanges.size.toLong()
            )
